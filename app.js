...
button.addEventListener('click', () => {
    ...
    if (input1.value > 0 || input2.value > 0) {
        ...
        alert('Error: Please input two values. One of the values must be greater than zero and both values cannot be zero.')
    };
});
//---------------------------------------------------------//
...
async function doMath(val1, val2) {
    ...
    //-------------------------------------------------------------------------------------------//        
        ...
        alert(error);
        for (i = 0; i < divArray.length; i++) {
            divArray[i].textContent = 'Error: Negative number encountered';
        };
    };
}; 
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////